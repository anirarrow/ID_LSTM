...
class Parser(object):
    def getParser(self):
        ...
        parser.add_argument('--dataset', type=str, default='../TrainData/IDFC')
        parser.add_argument('--maxlenth', type=int, default=300)
        parser.add_argument('--grained', type=int, default=30)
